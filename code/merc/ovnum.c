...
struct area_data *grok_area(struct char_data *ch, const char *arg, struct buf_type *out_buffer);
...
static void find_empty_vnums(char type, struct char_data *ch, const char *arg, struct buf_type *out_buffer)
{
    struct area_data *ad;
...
void ovnum_find_empty(struct char_data *ch, const char *arg, struct buf_type *out_buffer)
{
...
void mvnum_find_empty(struct char_data *ch, const char *arg, struct buf_type *out_buffer)
{
