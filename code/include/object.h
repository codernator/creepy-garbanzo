...
struct object_iterator_filter {
    ...
    /*@null@*/struct objecttemplate *object_template;
};
extern const OBJECT_ITERATOR_FILTER object_empty_filter;

/** Create a new object instance, tracked on the master object list, from the specified template. */
/*@dependent@*/struct gameobject *object_new(/*@dependent@*/struct objecttemplate *templatedata);
