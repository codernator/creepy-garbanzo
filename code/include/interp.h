...
DECLARE_DO_FUN(do_immtag);
DECLARE_DO_FUN(do_tagstop);
...
DECLARE_DO_FUN(do_notrivia);
DECLARE_DO_FUN(do_nowish);
...
DECLARE_DO_FUN(do_tokenstat);
DECLARE_DO_FUN(do_tokenshow);
DECLARE_DO_FUN(do_trade);
DECLARE_DO_FUN(do_train);
DECLARE_DO_FUN(do_transfer);
DECLARE_DO_FUN(do_trip);
DECLARE_DO_FUN(do_trust);
DECLARE_DO_FUN(do_tscratch);
...
DECLARE_DO_FUN(do_pack_bowl);
DECLARE_DO_FUN(do_unpack_bowl);
DECLARE_DO_FUN(do_hit_bowl);
...
DECLARE_DO_FUN(do_skillset);
DECLARE_DO_FUN(do_radio);
DECLARE_DO_FUN(do_immtest);
DECLARE_DO_FUN(do_listgods);
